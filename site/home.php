    ...
    <body>
            ...
            <header class="topbar">
                ...
                <div class="top-right">
                    <div class="auth-links hidden" id="auth-links">
                        <a class="auth-link" href="login/login.php">Giris Yap</a>
                        <a class="auth-link primary" href="login/register.php">Kayit Ol</a>
                    </div>
        ...
        <script>
            ...
            const profileNavLink = document.querySelector('a[href="profile/avatar.php"]');
            ...
            function resolveAvatarUrl(username, rawAvatar) {
                ...
                try {
                    ...
                    if (parsed.faceURL && typeof parsed.faceURL === "string") {
                        return parsed.faceURL;
                    }
